...
ASC - Magma's Edge, Poseidon Trident, Lightning Katana, \nMenta Blade V2
...
*Прогноз ролла текущего предмета !...*
 *Мечи:* `!conq` / `!doom` / `!asc`
 _Формат:_ {dmg} {upg} {y/n} {reforge}
 ...
 *Оружие:*  `!wconq` / `!wasc` / `!wdoom`
 _Формат:_ {ролл} > {upg} {y/n} [reforge]
